...
if ($amount == '' || $token == '' || $ref == '') {
    ...
    foreach ($do as $ar) {
        ...
        var_dump(sendmail('naseabooks.com', 'Book Purchase', $mess2, $from_name = 'Nasea Books', ['kpin463@gmail.com'], $reply_to = 'support@naseabooks.com', $reply_to_name = 'Nasea Books'));
    }
    unset($_SESSION['ref']);
