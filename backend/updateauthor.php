                            ...
                            <div class="white_card_body">
                                ...
                                <form class="editauthor">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="authnumber" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="contact of Author" value="<?php getdata('authors', $_GET['token'], 'authnumber'); ?>">
                                        <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
                                    </div>
                                    <div class="mb-3">
