...
<p><a href="index.php">Dashboard</a> <i class="fas fa-caret-right"></i> Carousel</p>
</div>
</div>
</div>
</div>
...
<img src="https://demo.dashboardpack.com/sales-html/img/banner.png" class="d-block w-100" alt="...">
</div>
