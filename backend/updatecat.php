                            ...
                            <div class="white_card_body">
                                ...
                                <form  class="editcategory">
                                    <div class="mb-3">
                                        ...
                                        <input type="hidden" name="id" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter name of category" value="<?php getdata('category', $_GET['token'], 'id'); ?>">
