...
<p><a href="index.php">Dashboard</a> <i class="fas fa-caret-right"></i> ChartJS</p>
</div>
</div>
</div>
</div>
...
<script src="https://demo.dashboardpack.com/sales-html/vendors/chartjs/chartjs_init.js"></script>
</body>
</html>